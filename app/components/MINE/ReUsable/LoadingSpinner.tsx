    ...
    return (
        <div className='SMALL_CONTAINER'>
            ...
            <section className="animate-pulse md:flex md:space-x-10">
                ...
                <article className="md:w-1/2 w-full mb-5 md:mb-0 h-95 bg-zinc-100 rounded-3xl" />
                ...
                <article className="md:w-1/2 w-full space-y-5">
                    ...
                    <div className="flex space-x-5 pt-2">
                        <div className="h-12 bg-green-100 rounded-3xl w-2/5"></div>
                        <div className="h-12 bg-zinc-100 rounded-3xl w-1/5"></div>
                    </div>
